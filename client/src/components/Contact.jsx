    ...
    <div>
        {landlord && (
            <div className="flex flex-col gap-2">
                <p className="text-2xl font-bold leading-relaxed text-gray-800">Contact <span className="font-semibold">{landlord.username}</span> for <span className="font-semibold">{listing.name.toLowerCase()}</span></p>
