    ...
    <div className="py-16">
      <div className="flex bg-white rounded-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl" style={{ boxShadow: "0 0 10px rgba(0, 0, 0, 0.3)" }}>
        ...
        <div className="w-full p-12 lg:w-1/2 rounded-lg">
          ...
          <h2 className="text-3xl font-bold text-gray-700 text-center">SIgn In</h2>
          ...
          <p className="text-gray-600 mt-2 text-center sm:text-left">Dont have an account? <Link to={"/sign-up"} className="text-[#3182CE] hover:underline">Sign up</Link></p>
